...
import { Switch2sensorPlatformAccessory } from './platformAccessory';
 ...
 */
export class switch2sensorHomebridgePlatform implements DynamicPlatformPlugin {
  ...
  /**
   * This is an switch2sensor method showing how to register discovered accessories.
  ...
  discoverDevices() {
    ...
    for (const device of switch2sensorDevices) {
      ...
      if (existingAccessory) {
        ...
        new Switch2sensorPlatformAccessory(this, existingAccessory);
        ...
        // this is imported from `platformAccessory.ts`
        new Switch2sensorPlatformAccessory(this, accessory);
